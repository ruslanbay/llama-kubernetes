...
Чтобы иметь простор для экспериментов, я воспользовался контейнерезацией. К тому же, это был хороший повод чтобы опробовать k0s - легковесный дистрибутив Kubernetes.
